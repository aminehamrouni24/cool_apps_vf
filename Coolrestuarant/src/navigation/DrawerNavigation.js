      ...
      <Animated.View style={StyleSheet.flatten([styles.stack, style])}>
        <Stack.Navigator>
          ...
          <Stack.Screen
            ...
            options={{headerShown: false}}
          />
          {/* Coupon Menu and Screens End -- See Component For Sub Menu Items */}
          ...
          <Stack.Screen
            name={Routes.ProductsModuleMenu}
            component={ProductsModuleMenu}
            options={{headerShown: false}}
          />
...
const DrawerContent = (props) => {
  ...
  const DrawerArray = [
    ...
    {
      title: 'My Products',
      iconPath: images.drawerMenuIcons.myProducts,
      routeName: Routes.ProductsModuleMenu,
      screen: Routes.ProductsHomeScreen,
    },
    {
      title: 'Profile',
    ...
    {
      title: 'Promo Codes',
      iconPath: images.drawerMenuIcons.promocodes,
      routeName: Routes.CouponModuleMenu,
      screen: Routes.CouponListScreen,
    },
    {
      title: 'Sales',
      iconPath: images.drawerMenuIcons.sales,
  ...
  return (
    <Drawer.Navigator
      ...
      drawerContentOptions={{
        ...
        activeTintColor: allColors.black,
        inactiveTintColor: allColors.black,
      }}
      sceneContainerStyle={globalStyles.bgYellow}
