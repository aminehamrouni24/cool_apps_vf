...
const LongButton = props => {
  ...
  //preceding icon style setup
  const precedingIconCommonStyle = {
    marginRight: horizontalScale(props.precedingIconPaddingRight),
    marginTop: verticalScale(
      props.precedingIconPaddingTop === 0 ? 5 : props.precedingIconPaddingTop,
    ),
  };
  ...
  const precedingIconComponent =
    props.precedingIconComponent && props.precedingIconComponent;
  ...
  return (
    <TouchableOpacity
      ...
      {/*--Tailing Icon Start--*/}
      {props.hasPrecedingIcon && (
        <View style={precedingIconCommonStyle}>{precedingIconComponent}</View>
      )}
      {/*--Tailing Icon End--*/}
...
LongButton.defaultProps = {
  ...
  hasPrecedingIcon: false,
  hasTailingIcon: false,
  isSquare: false,
  precedingIconComponent: null,
  precedingIconPaddingRight: 0,
  precedingIconPaddingTop: 0,
...
LongButton.propTypes = {
  ...
  hasPrecedingIcon: PropTypes.bool,
  hasTailingIcon: PropTypes.bool,
  isSquare: PropTypes.bool,
  onPress: PropTypes.func,
  precedingIconComponent: PropTypes.object,
  precedingIconPaddingRight: PropTypes.number,
  precedingIconPaddingTop: PropTypes.number,
