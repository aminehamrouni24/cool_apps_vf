...
export async function getCoordinates(address) {
  Geocoder.init('AIzaSyANG0-LliP9w-QPFBo1Oz7WyYoXgra2Tcc', {language: 'en'}); // set the language
  let latlong = await Geocoder.from(address);
  return latlong.results[0].geometry.location;
}
